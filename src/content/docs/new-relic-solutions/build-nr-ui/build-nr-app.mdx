...
<Callout variant="important">
      New Relic programmability and developer resources for building or using custom applications are part of [New Relic's Developer Program](/docs/licenses/product-or-service-licenses/new-relic-developer-edition/developer-program/) and subject to separate terms and requirements. Please see program page for details.
    </Callout>
